# genpark-financial-earnings-transcript-sentiment-tracker-skill
...
**genpark-financial-earnings-transcript-sentiment-tracker-skill** is a deterministic, zero-dependency Python skill engineered for autonomous AI agents, multi-agent frameworks (Claude Desktop, Cursor, AutoGPT, CrewAI), and enterprise pipelines.

> **Executive Capability**: Financial earnings call transcript tone shift & guidance sentiment tracker (Finnhub)
...
result = client.analyze_earnings_call_tone()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-financial-earnings-transcript-sentiment-tracker-skill": {
      "command": "python",
      "args": ["/path/to/genpark-financial-earnings-transcript-sentiment-tracker-skill/mcp_server.py"]
    }
  }
}
```
